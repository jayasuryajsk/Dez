...
impl HttpClientWithUrl {
    ...
    pub fn build_zed_api_url(&self, path: &str, query: &[(&str, &str)]) -> Result<Url> {
        ...
        let base_api_url = match base_url.as_ref() {
            ...
            "https://staging.tenderwriter.com" => "https://api-staging.tenderwriter.com",
            "https://tenderwriter.com" => "https://api.tenderwriter.com",
    ...
    pub fn build_zed_llm_url(&self, path: &str, query: &[(&str, &str)]) -> Result<Url> {
        ...
        let base_api_url = match base_url.as_ref() {
            ...
            "https://staging.tenderwriter.com" => "https://llm-staging.tenderwriter.com",
            "https://tenderwriter.com" => "https://llm.tenderwriter.com",
